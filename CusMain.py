...
class Ui_frm_cus_main(object):
    ...
    def setupUi(self, frm_cus_main):
        ...
        self.lbl_total.setGeometry(QtCore.QRect(80, 470, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Kanit")
        ...
        self.lbl_totaltxt.setGeometry(QtCore.QRect(20, 470, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Kanit")
        font.setPointSize(18)
    ...
    def addToTable(self, cursor, same_page=False):
        ...
        for i, v in enumerate(cursor):
            ...
            self.tbl_item.setItem(i, 0, QTableWidgetItem("{}".format(v['pid'])))
    ...
    def setupTable(self, count):
        ...
        self.tbl_item.setColumnWidth(1, 210)
        self.tbl_item.setColumnWidth(2, 280)
    ...
    def retranslateUi(self, frm_cus_main):
        ...
        self.lbl_total.setText(_translate("frm_cus_main", "0.-"))
